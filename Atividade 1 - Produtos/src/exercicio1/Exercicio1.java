...
public class Exercicio1 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            String[] options = {"Adicionar Produto", "Ver Produtos", "Sair"};
            ...
            if (choice == 0) {
                try {
                    ...
                    Produtos produtos = new Produtos(codigo, nome, preco, unidade, estoque);
                    controleProduto.adicionarProduto(produtos);
